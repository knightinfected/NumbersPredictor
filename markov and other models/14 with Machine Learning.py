...
# ----------------------
# MACHINE LEARNING PREDICTOR (RandomForest)
# ----------------------
features['Sum'] = features.sum(axis=1)
features['OddCount'] = features.apply(lambda x: sum(d % 2 for d in x), axis=1)
X = features
y1, y2, y3 = data['Digit1'], data['Digit2'], data['Digit3']
