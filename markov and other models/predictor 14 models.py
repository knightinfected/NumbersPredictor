...
# 11. Higher-Order Markov (Last 2 digits -> next)
if len(data) >= 3:
...
if len(data) > 10:
    ...
    lag_num = data['Winning_Numbers'].iloc[-best_lag]
else:
...
print(f"Higher-Order Markov                 {higher_markov_num:03d}")
print(f"Cluster Analysis (KMeans)           {cluster_num:03d}")
print(f"Lagged Correlation                  {lag_num:03d}")
print(f"Bayesian Updating                   {bayes_num:03d}")
